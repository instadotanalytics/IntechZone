  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      const waves = [
        ...
        { yR: 0.65, amp: 22, freq: 0.015, sp: 0.03, a: 0.07 },
        { yR: 0.82, amp: 16, freq: 0.01, sp: 0.018, a: 0.06 },
      ];
...
const FAQ = [
  {
    ...
    a: "We respond to all inquiries within 24 business hours. For urgent matters, call us directly and our team will assist you immediately.",
  },
  {
    q: "Do you offer free consultations?",
    a: "Yes! We offer a free 30-minute discovery call to understand your requirements and explore how we can help your business grow.",
  },
  {
    q: "Can you work with international clients?",
    a: "Absolutely. We work with clients across 15+ countries. Our team accommodates different time zones and communication preferences.",
  },
  {
    q: "What is your typical project timeline?",
    a: "Timelines vary by scope. A typical website takes 4–8 weeks; a complex enterprise app may take 3–6 months. We share a detailed roadmap after the discovery phase.",
  },
  {
    q: "Do you provide post-launch support?",
    a: "Yes. All our projects include a 30-day post-launch support window. Ongoing maintenance and AMC plans are also available.",
  },
  {
    q: "What industries do you specialize in?",
    a: "We have deep expertise in fintech, e-commerce, healthcare, SaaS, education, and manufacturing. Our team adapts quickly to any industry domain.",
  },
];
        ...
        <div className={styles.container}>
          ...
          <div className={styles.officeGrid}>
            {OFFICES.map((o, i) => (
              <div
                key={i}
                className={`${styles.officeCard} ${o.primary ? styles.officePrimary : ""} ${o.comingSoon ? styles.officeComingSoon : ""}`}
              >
                {o.primary && (
                  <div className={styles.hqBadge}>
                    <FiZap size={11} /> Headquarters
                  </div>
                )}
                {o.comingSoon && (
                  <div className={styles.comingSoonBadge}>
                    <FiClock size={11} /> Coming Soon
                  </div>
                )}
                ...
                <div className={styles.officeRow}>
                  ...
                  <a href={`tel:${o.phone}`} className={styles.officeLink}>
                    {o.phone}
                  </a>
                </div>
                <div className={styles.officeRow}>
                  <FiMail size={13} className={styles.officeRowIcon} />
                  <a href={`mailto:${o.email}`} className={styles.officeLink}>
                    {o.email}
                  </a>
                </div>
                <div className={styles.officeRow}>
          ...
          <div className={styles.faqSplit}>
            <div className={styles.faqLeft}>
              ...
              <p className={styles.sectionDesc} style={{ marginBottom: 28 }}>
                Everything you need to know before reaching out. Can't find your
                answer? Chat with us directly.
              </p>
              <div className={styles.faqContactBox}>
                <FiMessageCircle size={22} className={styles.blue} />
                <div>
                  <div className={styles.faqContactTitle}>
                    Still have questions?
                  </div>
                  <div className={styles.faqContactSub}>
                    Our team replies within 24 hours
                  </div>
                </div>
                <a
                  href="mailto:hello@intechzone.in"
